...
(
    ...
    user_type LowCardinality(Nullable(String)) CODEC(ZSTD(1)), 
    ...
    auditable_type LowCardinality(Nullable(String)) CODEC(ZSTD(1)), 
    auditable_id Nullable(String) CODEC(ZSTD(1)),
    old_values Map(LowCardinality(String), String) CODEC(ZSTD(1)),
    new_values Map(LowCardinality(String), String) CODEC(ZSTD(1)),
